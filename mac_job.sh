...
#${PETSC_MPIRUN} -n 4 ./p3D_acoustic.out -pc_type asm -pc_asm_overlap 2  -da_refine 3 -ksp_converged_reason
${PETSC_MPIRUN} -n 27 ./p3D_acoustic.out -pc_type  asm -pc_asm_overlap 2 -sub_pc_type ilu -da_refine 4 -ksp_converged_reason
